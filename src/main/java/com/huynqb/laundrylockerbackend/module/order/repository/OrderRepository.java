...
public interface OrderRepository extends JpaRepository<Order, Long> {
  ...
  // Customer: Get my orders with pagination (fetch orderDetails for response)
  @EntityGraph(attributePaths = {"orderDetails", "orderDetails.service"})
  Page<Order> findBySenderIdAndDeleteFlagFalse(Long senderId, Pageable pageable);

  // Customer: Get my orders by status (fetch orderDetails for response)
  @EntityGraph(attributePaths = {"orderDetails", "orderDetails.service"})
