...
/** Exception thrown when there is a conflict with the current state. Returns HTTP 409 Conflict. */
public class ConflictException extends BaseException {
  ...
  public static ConflictException forDuplicate(
      String entityName, String field, Object value, String code) {
    return new ConflictException(
        code, String.format("%s already exists with %s: %s", entityName, field, value));
  }
}
