...
/**
 * Utility class for throwing common exceptions with standardized error codes. Provides convenient
...
public final class ExceptionUtils {
  ...
  public static ConflictException duplicateEntity(
      String entityName, String field, Object value, String code) {
  ...
  public static ExternalServiceException externalServiceError(
      String serviceName, String message, Throwable cause) {
    return new ExternalServiceException(
        MessageConstants.E_EXTERNAL_SERVICE, serviceName, message, cause);
  }
}
